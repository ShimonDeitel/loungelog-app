...
struct ContentView: View {
    ...
    @State private var editingEntry: LoungelogEntry?
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Lounge Access Log")
            .toolbar {
...
struct EntryEditorView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(entry == nil ? "Add Visit" : "Edit Visit")
            .toolbar {
