...
final class LoungelogUITests: XCTestCase {
    ...
    func testFreeLimitTriggersPaywall() {
        ...
        XCTAssertTrue(app.buttons["purchaseButton"].waitForExistence(timeout: 3) || app.staticTexts["Lounge Access Log Pro"].waitForExistence(timeout: 3))
    }
